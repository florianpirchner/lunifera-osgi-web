 ...
 */
public abstract class AbstractFieldPresenter extends AbstractDisposable implements IWidgetPresentation<Component> {
	...
	public AbstractFieldPresenter(IUiEmbeddableEditpart editpart) {
