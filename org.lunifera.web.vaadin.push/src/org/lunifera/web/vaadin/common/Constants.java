...
public class Constants {
	...
	/**
	 * OSGi service component.name of the web application
	 */
	public static final String OSGI_COMP_NAME__WEBAPPLICATION = "org.lunifera.web.vaadin.webapplication";

	/**
	 * Alias the web application should be registered to
	 */
	public static final String OSGI_WEBAPP__ALIAS = "alias";
